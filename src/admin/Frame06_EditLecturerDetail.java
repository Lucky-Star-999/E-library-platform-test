 ...
 * @author ASUS
 */
public class Frame06_EditLecturerDetail extends javax.swing.JFrame {

    /**
     * Creates new form Frame06_EditLecturerDetail
     */
    public Frame06_EditLecturerDetail() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Note: Your information will not be saved if not click \"Save\"");
        ...
        jButton5.setText("Delete this lecturer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame06_EditLecturerDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame06_EditLecturerDetail().setVisible(true);
            }
        });
    }
